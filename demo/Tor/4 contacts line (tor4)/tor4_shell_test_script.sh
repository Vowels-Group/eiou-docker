...
docker exec eioud-0-tor eiou send "${containerAddresses[eioud-1-tor]}" 1 USD

echo -e "\t-> eioud-0-tor sends money to eioud-2-tor, through eioud-1-tor"
docker exec eioud-0-tor eiou send "${containerAddresses[eioud-2-tor]}" 1 USD

echo -e "\t-> eioud-0-tor sends money to eioud-3-tor, through eioud-1&2-tor"
docker exec eioud-0-tor eiou send "${containerAddresses[eioud-3-tor]}" 1 USD
