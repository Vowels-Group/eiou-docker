...
docker exec eioud-0-tor eiou send "${containerAddresses[eioud-1-tor]}" 100 USD

echo -e "\t-> eioud-0-tor sends money to eioud-2-tor, through eioud-1-tor"
docker exec eioud-0-tor eiou send "${containerAddresses[eioud-2-tor]}" 10 USD

echo -e "\t-> eioud-0-tor sends money to eioud-3-tor, through eioud-1&2-tor"
docker exec eioud-0-tor eiou send "${containerAddresses[eioud-3-tor]}" 20 USD

echo -e "\t-> eioud-4-tor sends money to eioud-0-tor, through eioud-3&2&1-tor"
docker exec eioud-4-tor eiou send "${containerAddresses[eioud-4-tor]}" 100 USD
...
docker exec eioud-0-tor eiou send "${containerAddresses[eioud-9-tor]}" 100 USD
