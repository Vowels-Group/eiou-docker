...
echo -e "\nCreating containers..."
docker run -d --network=demo-net --name eioud-0-http eioud
docker run -d --network=demo-net --name eioud-1-http eioud
docker run -d --network=demo-net --name eioud-2-http eioud
docker run -d --network=demo-net --name eioud-3-http eioud
docker run -d --network=demo-net --name eioud-4-http eioud
docker run -d --network=demo-net --name eioud-5-http eioud
docker run -d --network=demo-net --name eioud-6-http eioud
docker run -d --network=demo-net --name eioud-7-http eioud
docker run -d --network=demo-net --name eioud-8-http eioud
docker run -d --network=demo-net --name eioud-9-http eioud
