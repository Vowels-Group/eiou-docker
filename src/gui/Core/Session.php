 ...
 *
 * Provides secure session management for the eIOU GUI application.
 * Combines features from both the legacy session.php and the wallet-php pattern.
 * Encapsulates all session operations to avoid direct $_SESSION access.
 *
 * @package eIOUGUI\Core
 * @author Hive Mind Collective
 * @copyright 2025
 */

namespace eIOUGUI\Core;
