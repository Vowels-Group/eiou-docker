...
$pollerConfig = [
    'min_interval_ms' => getenv('CLEANUP_MIN_INTERVAL_MS') ?: 1000,   // 1 second minimum
    'max_interval_ms' => getenv('CLEANUP_MAX_INTERVAL_MS') ?: 30000,  // 30 seconds maximum
    'idle_interval_ms' => getenv('CLEANUP_IDLE_INTERVAL_MS') ?: 10000, // 10 seconds when idle
    'adaptive' => getenv('CLEANUP_ADAPTIVE_POLLING') !== 'false',
];
