<?php
/**
 * Unit Tests for CliP2pApprovalService
 *
 ...
 *
 * Extracted from CliServiceP2pApprovalTest as part of ARCH-04 refactor.
 */
...
#[CoversClass(CliP2pApprovalService::class)]
class CliP2pApprovalServiceTest extends TestCase
{
    ...
    private CliP2pApprovalService $service;
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new CliP2pApprovalService($this->currencyUtility);
    ...
    /**
     * Test displayPendingP2p errors when repository not set
     */
    public function testDisplayPendingP2pMissingDependencies(): void
    {
