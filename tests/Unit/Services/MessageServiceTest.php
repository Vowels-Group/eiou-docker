...
class MessageServiceTest extends TestCase
{
    ...
    // =========================================================================
    // Version compatibility guard tests
    // =========================================================================

    /**
     * Test handleMessageRequest rejects messages from contacts with no version (pre-v0.1.3)
     */
    public function testHandleMessageRequestRejectsNoVersion(): void
    {
        $request = [
            'typeMessage' => 'transaction',
            'senderAddress' => self::TEST_ADDRESS,
            'senderPublicKey' => self::TEST_PUBLIC_KEY,
            // No 'version' field — simulates old node
        ];
        ...
        $this->contactRepository->expects($this->once())
            ...
            ->with(self::TEST_PUBLIC_KEY, ['remote_version' => null]);
    ...
    /**
     * Test handleMessageRequest rejects messages from contacts with old version
     */
    public function testHandleMessageRequestRejectsOldVersion(): void
    {
        $request = [
            'typeMessage' => 'transaction',
            'senderAddress' => self::TEST_ADDRESS,
        ...
        $this->contactRepository->expects($this->once())
            ->method('updateContactFields')
            ->with(self::TEST_PUBLIC_KEY, ['remote_version' => '0.1.0-alpha']);
    ...
    /**
     * Test handleMessageRequest accepts messages from contacts with compatible version
     */
    public function testHandleMessageRequestAcceptsCompatibleVersion(): void
    {
        $request = [
            'typeMessage' => 'contact',
            'senderAddress' => self::TEST_ADDRESS,
        ...
        // Should update stored version
        $this->contactRepository->expects($this->once())
            ->method('updateContactFields')
            ->with(self::TEST_PUBLIC_KEY, ['remote_version' => Constants::APP_VERSION]);
    ...
    /**
     * Test handleMessageRequest does not update DB when version unchanged
     */
    public function testHandleMessageRequestSkipsUpdateWhenVersionUnchanged(): void
    {
        $request = [
            'typeMessage' => 'contact',
            'senderAddress' => self::TEST_ADDRESS,
        ...
        $this->contactRepository->method('getContactByPubkey')
            ...
            ->willReturn([
                'pubkey' => self::TEST_PUBLIC_KEY,
                'status' => 'accepted',
                'remote_version' => Constants::APP_VERSION, // Already stored
            ]);
        ...
        // Should NOT update since version hasn't changed
