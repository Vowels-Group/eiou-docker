...
docker volume rm ${restoreContainer}-mysql-data ${restoreContainer}-config ${restoreContainer}-backups ${restoreContainer}-ssl-cert > /dev/null 2>&1
...
docker volume rm ${restoreFileContainer}-mysql-data ${restoreFileContainer}-config ${restoreFileContainer}-backups ${restoreFileContainer}-ssl-cert > /dev/null 2>&1
...
docker volume rm ${restoreEnvContainer}-mysql-data ${restoreEnvContainer}-config ${restoreEnvContainer}-backups ${restoreEnvContainer}-ssl-cert > /dev/null 2>&1
...
docker volume rm ${authcodeRestoreContainer}-mysql-data ${authcodeRestoreContainer}-config ${authcodeRestoreContainer}-backups ${authcodeRestoreContainer}-ssl-cert 2>/dev/null
...
docker volume rm ${restoreQsContainer}-mysql-data ${restoreQsContainer}-config ${restoreQsContainer}-backups ${restoreQsContainer}-ssl-cert > /dev/null 2>&1
...
docker volume rm ${restoreQsContainer}-mysql-data ${restoreQsContainer}-config ${restoreQsContainer}-backups ${restoreQsContainer}-ssl-cert 2>/dev/null
...
docker volume rm ${restoreFileQsContainer}-mysql-data ${restoreFileQsContainer}-config ${restoreFileQsContainer}-backups ${restoreFileQsContainer}-ssl-cert > /dev/null 2>&1
...
docker volume rm ${restoreFileQsContainer}-mysql-data ${restoreFileQsContainer}-config ${restoreFileQsContainer}-backups ${restoreFileQsContainer}-ssl-cert 2>/dev/null
rm -f "${hostSeedFileQs}"
