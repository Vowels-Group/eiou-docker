...
# Check for success and user_info data structure
if [[ "$infoJsonOutput" =~ '"success"' ]] && [[ "$infoJsonOutput" =~ 'true' ]] && [[ "$infoJsonOutput" =~ '"user_info"' ]]; then
...
# Check for success and user_info data structure
if [[ "$infoDetailJsonOutput" =~ '"success"' ]] && [[ "$infoDetailJsonOutput" =~ 'true' ]] && [[ "$infoDetailJsonOutput" =~ '"user_info"' ]]; then
...
for container in "${containers[@]}"; do
    ...
    if [[ "$containerInfoJson" =~ '"success"' ]] && [[ "$containerInfoJson" =~ 'true' ]] && [[ "$containerInfoJson" =~ '"user_info"' ]]; then
