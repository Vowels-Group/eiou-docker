...
addResultA=$(docker exec ${containerA} eiou add ${addressB} TestContactB 0.1 1000 0.01 USD 2>&1)
...
addResultB=$(docker exec ${containerB} eiou add ${addressA} TestContactA 0.1 1000 0.01 USD 2>&1)
