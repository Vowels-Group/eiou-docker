...
class Logger implements LoggerInterface
{
    ...
    #[\Eiou\Contracts\PluginCallable(description: 'Write a debug-level log entry to the wallet log under the plugin name.')]
    public function debug(string $message, array $context = []): void
    {
        self::doLog('DEBUG', $message, $context);
    }

    #[\Eiou\Contracts\PluginCallable(description: 'Write an info-level log entry to the wallet log under the plugin name.')]
    public function info(string $message, array $context = []): void
    {
        self::doLog('INFO', $message, $context);
    }

    #[\Eiou\Contracts\PluginCallable(description: 'Write a warning-level log entry to the wallet log under the plugin name.')]
    public function warning(string $message, array $context = []): void
    {
        self::doLog('WARNING', $message, $context);
    }

    #[\Eiou\Contracts\PluginCallable(description: 'Write an error-level log entry to the wallet log under the plugin name.')]
