...
// Host-owned Plugins tab. Each enabled plugin that declared
// `plugin_tab_panel` in its manifest registered an entry into
// PluginsTabPanelRegistry during PluginIpcForwarder::registerAll();
// this tab renders the operator-facing dropdown over those entries.
// The tab body is generated by a partial in wallet.html's scope so
// it can reach $serviceContainer for the registry pull without
// threading it through a closure capture.
$tabRegistry->register([
    'id'      => 'plugins',
    'label'   => 'Plugins',
    'icon'    => 'fas fa-puzzle-piece',
    'order'   => 45,
    'include' => '/app/eiou/src/gui/layout/walletSubParts/pluginsTab.html',
]);
$tabRegistry->register([
    'id'      => 'settings',
    'label'   => 'Settings',
