...
### M-1: Raw SQL Execution from Backup File Content
...
### M-2: Session Cookie `secure` Flag Conditional on HTTPS
...
### M-3: CSRF Token Not Rotated After Use
...
### M-4: Rate Limiting Bypass via Environment Variable
...
### M-5: Information Leakage in API Error Responses
...
### M-6: Duplicate CSRF Token Implementation
...
### M-7: `sanitizeInput()` Only Removes Null Bytes
...
### M-8: CORS Wildcard Configuration Possible
...
### M-9: `validateRequestLevel()` Trusts Request-Supplied Maximum
...
### M-10: Exception Messages Exposed in Non-Production
...
### M-11: Unencoded Transaction Date in Template
...
### M-12: API Key Secret Echoed to Docker Logs
...
### M-14: Legacy Plaintext Private Key Check in UserContext
...
### M-15: Decrypted Backup Written to /tmp Without Encryption
...
### M-16: No P2P Request Rate Limiting
...
### M-17: Transaction Recovery Lacks Authorization
...
### M-18: P2P Message Authentication Weakness
...
### M-19: Sync Continues After Signature Failures
...
### M-20: Contact Sync Accepts Unvalidated Remote Addresses
...
### M-21: Held Transactions Processed Despite Chain Integrity Failure
...
### M-23: No Container Security Hardening
...
### M-25: HTTP Port Exposed Without Redirect to HTTPS
...
### M-26: SSL/TLS Protocol and Cipher Hardening Missing
...
### M-27: Payload Sent via URL Query Parameter
...
### M-28: Timestamp-Only Nonce for P2P Replay Protection
...
### M-29: Composer Installed Without Hash Verification
...
### M-30: MariaDB Runs With Default Configuration
...
### M-32: Balance Overflow Not Checked
