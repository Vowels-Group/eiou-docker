...
# Plugin sandboxing (Phase 2): eiou-locations.conf includes a per-plugin
# routing snippet that is regenerated by PluginNginxConfigService when a
...
RUN mkdir -p /etc/nginx/snippets && \
    printf '# Auto-generated by PluginNginxConfigService — initially empty.\n# Populated when a sandboxed plugin enables. See docs/PLUGIN_SANDBOXING.md.\n' \
