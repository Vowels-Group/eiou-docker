...
- **Payment request history sorting and filtering**: history table has sortable Amount and Date columns (click to toggle asc/desc/original) and dropdown filters for status (Paid/Declined/Cancelled) and direction (Incoming/Outgoing)
