...
- Strengthen P2P message hash with sender public key binding (M-18) — hash formula changed from `hash(address + salt + time)` to `hash(senderPublicKey + address + salt + time)`; **breaking: legacy hash format no longer accepted**
