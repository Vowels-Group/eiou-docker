...
- **DLQ icon not centered in Recent Transactions**: the inline DLQ delivery-failure icon sat off-center next to the status icon. Changed to block display below the status icon for proper centering
